/**
 * HRTrader Pro Ultimate v5.6 — Anti-Auto-Start & Instant One-Shot Scheduler
...
(function () {
  ...
  function initHRTrader() {
    ...
    // কারেন্ট টাইম থেকে ১ মিনিট পরের টাইম জেনারেট করার ফাংশন
    ...
    function loadSettings() {
      try {
        ...
        if (stored) {
          ...
          // ফিক্সড: বুট বা রিলোডের সময় স্টোরেজের পুরোনো পেন্ডিং টাইম ইগনোর করে সেফ ফিউচার টাইম দেওয়া হবে যেন অটো রান না হয়
    ...
    function syncUI() {
      ...
      // প্যানেল খোলার সময় ডিসপ্লেতে সবসময় প্লাস ১ মিনিট পরের সেফ টাইম দেখাবে
    ...
    function saveAll() {
      ...
      startShutdownTimer();
      // সেভ করার পর নতুন টাইম শিডিউল চালু হবে
    ...
    function startPendingScheduler() {
      ...
      // ফিক্সড: ১০০ মিলি-সেকেন্ড পর পর নিখুঁতভাবে রিয়েল-টাইম চেক করবে
      pendingCheckInterval = setInterval(() => {
        ...
        // ফিক্সড: টাইম ম্যাচ হওয়া মাত্রই লুপ ক্লিয়ার করে দেওয়া হবে যাতে সেকেন্ডের মাথায় সিঙ্গেল ওয়ান-শট ট্রেড পড়ে।
    ...
    console.log("HRTrader Ultimate v5.6 Anti-Bug Protocol Loaded!");
  }
