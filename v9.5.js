...
(function () {
  ...
  function initHRTrader() {
    ...
    // ৪. রেস কন্ডিশন পেন্ডিং শিডিউলার বাগ ফিক্স (Race Condition Safe)
    ...
    function startPendingScheduler() {
      ...
      pendingCheckInterval = setInterval(() => {
        ...
        // সুনির্দিষ্ট মিনিটে মাত্র একবারই ফায়ার হবে, সেকেন্ড মিস হওয়ার চান্স নেই
        if (currentHHMM === settings.pendingTime && lastExecutedMinute !== currentHHMM) {
      ...
      }, 400); // ৪০০ms ইন্টারভাল সেফ ব্রাউজিং স্পিড নিশ্চিত করে
    }
