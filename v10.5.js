...
(function () {
  ...
  function getPlatformTimeOffsetMs() {
    ...
    const now = new Date();
    const platformTime = new Date(now.getFullYear(), now.getMonth(), now.getDate(), hh, mm, ss, 0);
    return platformTime.getTime() - now.getTime();
  }
  ...
  function startPendingScheduler() {
    ...
    const offsetMs = getPlatformTimeOffsetMs();
    ...
    // ব্যাকগ্রাউন্ড ট্যাবে rAF থ্রটল হতে পারে বলে ব্যাকআপ ইন্টারভাল; এখন Date.now() টাইমস্ট্যাম্প
    // তুলনা করছি বলে ১০ms রেজোলিউশনেও নির্ভুল থাকবে (আগে DOM টেক্সট re-parse করায় ছিল না)
