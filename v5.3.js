/**
 * HRTrader Pro Ultimate v5.3 — Save Button Fixed & Easy Timer Edition
...
(function () {
  ...
  function initHRTrader() {
    ...
    function saveAll() {
      ...
      settings.slAmount = Math.max(1, parseFloat(slInput.value) || 30); // ফিক্সড: slAmount.value থেকে slInput.value তে পরিবর্তন করা হয়েছে
    ...
    console.log("HRTrader Ultimate v5.3 Successfully Updated & Save Button Fixed!");
  }
