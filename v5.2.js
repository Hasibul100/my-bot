/**
 * HRTrader Pro Ultimate v5.2 — Ultimate Control & Easy Timer Edition
...
(function () {
  ...
  function initHRTrader() {
    ...
    function syncUI() {
      ...
      // ড্যাশবোর্ড খুললেই সবসময় কারেন্ট টাইম ডিফল্ট লোড হবে
    ...
    function executePlatformTrade(customDir = null, customAmount = null) {
      ...
      try {
        ...
        // ফিক্সড: অটোমেটিক ব্যাক-টু-ব্যাক মার্টিনগেল বা সেলফ-ট্রেড ট্রিগার টোটালি রিমুভড।
        // এখন রোবট আপনার ক্লিক বা শিডিউল ছাড়া নিজে থেকে আর কোনো ২য় ট্রেড নিবে না।
    ...
    function startPendingScheduler() {
      ...
      pendingCheckInterval = setInterval(() => {
        ...
        // ফিক্সড: সেকেন্ড ছাড়াই শুধুমাত্র ঘন্টা ও মিনিট মিললেই ট্রেড এক্সিকিউট হবে
    ...
    console.log("HRTrader Ultimate v5.2 Successfully Updated!");
  }
