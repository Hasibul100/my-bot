 ...
 * 100% Fixed: Win/Loss Tracker, Enter Key Crash, Continuous Trade Loop.
 */
(function () {
  ...
  function showPasswordGate(onSuccess) {
    ...
    input.addEventListener("keydown", (e) => { 
      if (e.key === "Enter") {
        e.preventDefault(); // ফিক্সড: ক্র্যাশ প্রোটেকশন
        tryLogin(); 
      }
    });
  ...
  function initHRTrader() {
    ...
    function startBalanceTracker() {
      ...
      balanceCheckInterval = setInterval(() => {
        ...
        if (current !== sessionStats.lastBalance) {
          ...
          // ফিক্সড: উইন এবং লস ট্র্যাকিং সঠিকভাবে কাজ করবে
          if (current > sessionStats.lastBalance) {
    ...
    function executePlatformTrade(customDir = null) {
      ...
      // ফিক্সড: পেন্ডিং ট্রেড অটো স্টপ করবে, কিন্তু রেগুলার স্ক্যান লুপ চালু রাখবে
      if (customDir) {
        stopScanSession();
      }
    }
    ...
    function startAutoTrade() {
      ...
      // ফিক্সড: কন্টিনিউয়াস লুপ মোড যা প্রতি ডিলে পর পর নিজে থেকেই লুপ করবে
