 ...
 * 100% Fixed: Immediate Trade Execution, Touch Sensitivity, UI Bugs.
 */
(function () {
  ...
  function showPasswordGate(onSuccess) {
    ...
    loginStyle.textContent = `
      ...
      #hrtrader-login-box { width: min(320px, calc(100vw - 32px)); padding: 25px 20px; border-radius: 14px; background: linear-gradient(160deg, #24121a 0%, #0f0a0d 100%); border: 1px solid #ffb6c1; box-shadow: 0 0 50px rgba(255, 182, 193, 0.25); }
      #hrtrader-login-box h3 { margin: 0 0 6px; text-align: center; color: #ffb6c1; font-size: 20px; letter-spacing: 0.05em; }
      #hrtrader-login-box p { margin: 0 0 15px; text-align: center; font-size: 12px; color: #f7d6dc; }
      #hrtrader-login-input { box-sizing: border-box; width: 100%; padding: 12px; border-radius: 8px; border: 1px solid rgba(255, 182, 193, 0.4); background: rgba(0, 0, 0, 0.5); color: #fff; font-size: 16px; outline: none; text-align: center; }
      #hrtrader-login-btn { width: 100%; margin-top: 15px; padding: 12px; border: none; border-radius: 8px; background: #ffb6c1; color: #24121a; font-weight: 700; font-size: 15px; cursor: pointer; }
  ...
  function initHRTrader() {
    ...
    for(let i=0; i<36; i++) {
      ...
      cell.style.cssText = "border: 1px dashed rgba(255, 182, 193, 0.15);";
    ...
    style.textContent = `
      ...
      #hrtrader-widget.hrtrader-glow { filter: drop-shadow(0 0 20px #ffb6c1); }
      #hrtrader-logo-wrap { width: 56px; height: 56px; border-radius: 50%; background: radial-gradient(circle, #24121a 0%, #050806 100%); display: flex; align-items: center; justify-content: center; pointer-events: none; border: 2.5px solid #ffb6c1; box-shadow: inset 0 0 10px rgba(255,182,193,0.5); }
      #hrtrader-label { font-family: system-ui, sans-serif; font-size: 11px; font-weight: 800; color: #ffb6c1; text-shadow: 0 2px 4px #000; text-transform: uppercase; letter-spacing: 0.05em; background: rgba(0,0,0,0.7); padding: 2px 6px; border-radius: 10px; border: 1px solid rgba(255,182,193,0.2); white-space: nowrap; }
      
      #hrtrader-panel { position: fixed; z-index: 2147483647; left: 50%; top: 50%; transform: translate(-50%, -50%); display: none; width: min(350px, calc(100vw - 20px)); max-height: 85vh; overflow-y: auto; padding: 20px; border-radius: 14px; background: linear-gradient(160deg, #24121a 0%, #0f0a0d 100%); border: 1px solid #ffb6c1; box-shadow: 0 12px 40px rgba(0,0,0,0.7); font-family: system-ui, sans-serif; color: #ffe8ee; }
      #hrtrader-panel.hrtrader-panel-open { display: block; }
      #hrtrader-panel h3 { margin: 0 0 12px; font-size: 18px; text-align: center; color: #ffb6c1; letter-spacing: 0.05em; border-bottom: 1px solid rgba(255,182,193,0.2); padding-bottom: 6px; }
      #hrtrader-panel h4 { margin: 10px 0 6px; font-size: 13px; color: #ffb6c1; text-transform: uppercase; letter-spacing: 0.03em; }
      ...
      #hrtrader-panel label { display: block; font-size: 11px; color: #f7d6dc; margin-bottom: 3px; font-weight: 600; }
      #hrtrader-panel input, #hrtrader-panel select { box-sizing: border-box; width: 100%; padding: 8px 10px; border-radius: 6px; border: 1px solid rgba(255,182,193,0.3); background: rgba(0,0,0,0.4); color: #fff; font-size: 13px; outline: none; }
      
      #hrtrader-dir-group { display: flex; gap: 6px; }
      #hrtrader-dir-group button { flex: 1; padding: 8px; border-radius: 6px; border: 1px solid rgba(255,182,193,0.25); background: rgba(0,0,0,0.3); color: #ffe8ee; font-size: 12px; font-weight: 600; cursor: pointer; }
      #hrtrader-dir-group button.hrtrader-dir-active { background: rgba(255,182,193,0.2); border-color: #ffb6c1; color: #ffb6c1; }
      
      .time-control-group { display: flex; gap: 4px; align-items: center; }
      .time-btn { padding: 8px 10px; background: rgba(255, 182, 193, 0.15); border: 1px solid #ffb6c1; color: #ffb6c1; border-radius: 6px; font-size: 12px; font-weight: bold; cursor: pointer; white-space: nowrap; }
      .time-btn:hover { background: rgba(255, 182, 193, 0.3); }

      .hrtrader-btn-action { display: block; width: 100%; padding: 12px; margin-top: 15px; border: none; border-radius: 6px; background: #ffb6c1; color: #24121a; font-weight: 700; font-size: 14px; cursor: pointer; text-align: center; }
      ...
      .stat-badge { background: rgba(255,182,193,0.1); border: 1px solid rgba(255,182,193,0.2); padding: 8px; border-radius: 6px; text-align: center; font-size: 12px; }
      .stat-title { font-size: 10px; color: #f7d6dc; display: block; }
      .stat-val { font-size: 14px; font-weight: 700; color: #ffb6c1; }
      .stat-win { color: #00ff66; }
      .stat-loss { color: #ff5252; }
      .section-divider { border-top: 1px dashed rgba(255, 182, 193, 0.2); margin: 15px 0 10px; }

      .switch-wrap { display: flex; align-items: center; justify-content: space-between; background: rgba(255, 182, 193, 0.05); padding: 8px 12px; border-radius: 8px; border: 1px dashed rgba(255, 182, 193, 0.2); margin-bottom: 10px; }
      .switch { position: relative; display: inline-block; width: 44px; height: 22px; }
      .switch input { opacity: 0; width: 0; height: 0; }
      .slider { position: absolute; cursor: pointer; inset: 0; background-color: #3a222d; transition: .3s; border-radius: 22px; border: 1px solid rgba(255, 182, 193, 0.3); }
      .slider:before { position: absolute; content: ""; height: 14px; width: 14px; left: 3px; bottom: 3px; background-color: #f7d6dc; transition: .3s; border-radius: 50%; }
      input:checked + .slider { background-color: #ffb6c1; border-color: #ffb6c1; }
      input:checked + .slider:before { transform: translateX(22px); background-color: #24121a; }
      ...
      #hrtrader-scan-line { position: absolute; left: 0; width: 100%; height: 4px; background: #ffb6c1; box-shadow: 0 0 20px #ffb6c1; top: -5%; animation: hrtrader-scan-move 1.5s linear infinite; }
    ...
    panel.innerHTML = `
      ...
      <div class="switch-wrap">
        <span style="font-size: 12px; font-weight: bold; color: #ffb6c1;">পেন্ডিং ট্রেড চালু করুন (ON/OFF)</span>
        <label class="switch">
      ...
      <div class="hrtrader-row">
        ...
        <div class="time-control-group">
          ...
          <input id="cfg-pending-time" type="text" placeholder="HH:MM" style="text-align: center; font-weight: bold; font-size: 15px; color: #ffb6c1;" />
    ...
    widget.innerHTML = `
      <div id="hrtrader-logo-wrap">
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M12 2a3 3 0 0 0-3 3v1H5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-4V5a3 3 0 0 0-3-3zm-1 3a1 1 0 0 1 2 0v1h-2V5zm-6 3h14v10H5V8zm4 3a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm6 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm-6 4h6v1H9v-1z" fill="#ffb6c1"/>
        </svg>
      </div>
    ...
    function getAccountBalance() {
      let balEl = document.querySelector(".balance-value, .us-balance, .v2KPX, [data-test='balance-value']");
      if (balEl) {
        let val = parseFloat(balEl.textContent.replace(/[^0-9.]/g, ""));
    ...
    function getCurrentPayoutPercent() {
      let payoutEl = document.querySelector(".OmOPV .eB25d, #mobile-asset-btn .UI2Kh, .percent-value");
      if (payoutEl) {
  ...
  function startBalanceTracker() {
    ...
    // ফিক্সড: মাল্টিপল বাটন ক্লাস যুক্ত করা হয়েছে 
    function getTradeButtons() {
      let upBtn = document.querySelector(".JQZcs, .btn-call, .btn-up, .btn-success");
      let downBtn = document.querySelector(".twQq3, .btn-put, .btn-down, .btn-danger");
    ...
    function executePlatformTrade(customDir = null) {
      ...
      if (!up || !down) {
        console.error("HRTrader: Trade buttons not found!");
        stopScanSession();
        return;
      }
    ...
    function startPendingScheduler() {
      ...
      console.log(`[HRTrader] Scheduler Armed for ${settings.pendingTime}.`);
      ...
      function checkTimeHighPrecision() {
        ...
        if (platformClockEl) {
          let pParts = platformClockEl.textContent.trim().split(":");
          if (pParts.length >= 2) {
      ...
      pendingAnimationId = requestAnimationFrame(checkTimeHighPrecision);
      pendingBackupInterval = setInterval(checkTimeHighPrecision, 20); 
    }

    // ফিক্সড: অটো ট্রেড এখন ক্লিক করার সাথে সাথেই শুরু হবে
    function startAutoTrade() {
      ...
      executePlatformTrade(); // প্রথম ট্রেড ইনস্ট্যান্ট
    ...
    document.addEventListener("mousemove", (e) => {
      ...
      // ফিক্সড: ড্র্যাগ সেন্সিটিভিটি কমানো হয়েছে (15 থেকে 25 পিক্সেল করা হয়েছে)
    ...
    document.addEventListener("touchmove", (e) => {
      ...
      // ফিক্সড: টাচ সেন্সিটিভিটি কমানো হয়েছে
      if (Math.abs(dx) > 25 || Math.abs(dy) > 25) moved = true;
      widget.style.left = Math.max(0, Math.min(startLeft + dx, window.innerWidth - 70)) + "px";
      widget.style.top = Math.max(0, Math.min(startTop + dy, window.innerHeight - 90)) + "px";
    }, { passive: true });
    ...
    console.log("HRTrader Ultimate Mobile-Ready Pro v9.9 Active & Fixed!");
  }
