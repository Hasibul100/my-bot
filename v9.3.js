/**
 * HRTrader Pro v9.3 — Zero Amount Control Edition (Pure Click Execution)
 * No input-field tampering. Uses whatever amount is pre-set on the platform by the user.
 */
(function () {
  ...
  function initHRTrader() {
    ...
    panel.innerHTML = `
      <h3>HRTrader Robot Dashboard (v9.3)</h3>
    ...
    function executePlatformTrade(customDir = null) {
      ...
      try {
        ...
        console.log(`[HRTrader] Pure Click Success on: ${finalDir} (Using manual pre-set amount)`);
      } catch(e) {
    ...
    function startPendingScheduler() {
      ...
      pendingCheckInterval = setInterval(() => {
        ...
        // অ্যামাউন্ট ট্র্যাকিং বাদ দেওয়ায় এখন ঠিক এক্স্যাক্ট সেকেন্ডে ইনস্ট্যান্ট ফায়ার হবে
    ...
    console.log("HRTrader Pure Click Edition v9.3 Active!");
  }
