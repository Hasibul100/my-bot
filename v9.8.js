...
(function () {
  ...
  function initHRTrader() {
    ...
    // ৫. আল্ট্রা-ফাস্ট পেন্ডিং শিডিউলার (০ms লেটেন্সি লজিক — ডাবল ক্লিক প্রটেক্টেড)
                                                                      ...
                                                                      const targetHH = parseInt(targetParts[0]) || 0;
                                                                            const targetMM = parseInt(targetParts[1]) || 0;
                                                                                  ...
                                                                                  console.log(`[HRTrader] Scheduler Armed for ${settings.pendingTime}. Zero latency mode active.`);
                                                                                              ...
                                                                                              let isExecuted = false; // ডাবল ক্লিক আটকানোর সেফটি লক
